...
public class Constants {
    ...
    public static final int ACCESS_CAMERA = 3;
    public static final int IMAGE_CAPTURE_CODE = 4;
    public static final int IMAGE_PICK_CODE = 5;
    ...
    public static final String ADD_REAL_ESTATE_FRAGMENT = "AddRealEstateFragment";
    public static final String EDIT_REAL_ESTATE_FRAGMENT = "EditRealEstateFragment";
